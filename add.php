...
<title>Crawly | Afegeix un enlla&ccedil; a Crawly</title>
...
<div id="menu">
<a href="/" class="submenu">... torna al Cercador</a> <a href="about.php" class="submenu">Qu&egrave; &eacute;s aix&ograve;?</a>
</div>
<br>
<br>
<br>
...
<br>
<br>
<center><div class="welcome">Afegeix el teu enlla&ccedil; a <font style="font-family: Cranberry;">crawly</font></div><center>
<br>
<br>
<form action="complete.php" method="post">
<input type="text" name="webpage" id="webpage" autocomplete="off" value="http://" />
<input type="submit" value="Afegir" id="afegir" />
</form>
